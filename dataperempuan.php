...
<body>
    <h1 style="text-align: center; color: black; font-weight: 400;">Data Laki Laki</h1>
    ...
    <table border="1" style="width: 80%; text-align: center">
        <tr style="background-color: pink; color: black; font-weight: 500; font-family: Arial;">
            ...
            <th width="20%">ALmat</th>
            <th width="25%">Option</th>
        </tr>
        <?php
        $data = mysqli_query($koneksi, "SELECT * FROM mahasiswa WHERE jenis_kelamin LIKE 'P'");
